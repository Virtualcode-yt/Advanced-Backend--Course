import { AgentAction, AgentFinish } from "../../src/agents.cjs";
import { Serialized } from "../../src/load/serializable.cjs";
import { BaseMessage } from "../../src/messages/base.cjs";
import { LLMResult } from "../../src/outputs.cjs";
import { ChainValues } from "../../src/utils/types/index.cjs";
import { ChatModelStreamEvent } from "../../src/language_models/event.cjs";
import { DocumentInterface } from "../../src/documents/document.cjs";
import { BaseCallbackHandler, CallbackHandlerMethods, HandleLLMNewTokenCallbackFields, NewTokenIndices } from "../../src/callbacks/base.cjs";
...
declare class CallbackManagerForLLMRun extends BaseRunManager implements BaseCallbackManagerMethods {
  ...
  handleChatModelStreamEvent(event: ChatModelStreamEvent): Promise<void>;
