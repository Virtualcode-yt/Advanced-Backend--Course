import { BaseMessage, BaseMessageChunk, BaseMessageLike } from "../../src/messages/base.cjs";
import { AIMessageChunk } from "../../src/messages/ai.cjs";
import { MessageOutputVersion } from "../../src/messages/message.cjs";
import { ChatGenerationChunk, ChatResult, Generation, LLMResult } from "../../src/outputs.cjs";
import { BaseCache } from "../../src/caches/index.cjs";
import { SerializableSchema } from "../../src/utils/standard_schema.cjs";
import { ZodV3Like, ZodV4Like } from "../../src/utils/types/zod.cjs";
import { ChatModelStreamEvent } from "../../src/language_models/event.cjs";
import { CallbackManagerForLLMRun, Callbacks } from "../../src/callbacks/manager.cjs";
import { RunnableConfig } from "../../src/runnables/types.cjs";
import { Runnable, RunnableToolLike } from "../../src/runnables/base.cjs";
import { BasePromptValueInterface } from "../../src/prompt_values.cjs";
import { BaseLanguageModel, BaseLanguageModelCallOptions, BaseLanguageModelInput, BaseLanguageModelParams, StructuredOutputMethodOptions, ToolDefinition } from "../../src/language_models/base.cjs";
import { StructuredToolInterface, StructuredToolParams } from "../../src/tools/types.cjs";
import { ChatModelStream } from "../../src/language_models/stream.cjs";
...
declare abstract class BaseChatModel<CallOptions extends BaseChatModelCallOptions = BaseChatModelCallOptions, OutputMessageType extends BaseMessageChunk = AIMessageChunk> extends BaseLanguageModel<OutputMessageType, CallOptions> {
   ...
   * ```
   */
  streamV2(input: BaseLanguageModelInput, options?: Partial<CallOptions>): ChatModelStream;
  ...
  withStructuredOutput<RunOutput extends Record<string, any> = Record<string, any>>(outputSchema: ZodV4Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<false>): Runnable<BaseLanguageModelInput, RunOutput>;
  withStructuredOutput<RunOutput extends Record<string, any> = Record<string, any>>(outputSchema: ZodV4Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<true>): Runnable<BaseLanguageModelInput, {
    raw: BaseMessage;
    parsed: RunOutput;
  }>;
  withStructuredOutput<RunOutput extends Record<string, any> = Record<string, any>>(outputSchema: ZodV3Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<false>): Runnable<BaseLanguageModelInput, RunOutput>;
  withStructuredOutput<RunOutput extends Record<string, any> = Record<string, any>>(outputSchema: ZodV3Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<true>): Runnable<BaseLanguageModelInput, {
    raw: BaseMessage;
    parsed: RunOutput;
  }>;
}
