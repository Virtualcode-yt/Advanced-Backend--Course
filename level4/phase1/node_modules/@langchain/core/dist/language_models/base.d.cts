import { BaseMessage, BaseMessageLike, MessageContent } from "../../src/messages/base.cjs";
import { LLMResult } from "../../src/outputs.cjs";
import { BaseCache } from "../../src/caches/index.cjs";
import { SerializableSchema } from "../../src/utils/standard_schema.cjs";
import { InferInteropZodOutput, InteropZodObject, InteropZodType, ZodV3Like, ZodV4Like } from "../../src/utils/types/zod.cjs";
import { CallbackManager, Callbacks } from "../../src/callbacks/manager.cjs";
import { RunnableConfig, RunnableInterface } from "../../src/runnables/types.cjs";
import { Runnable } from "../../src/runnables/base.cjs";
import { BasePromptValueInterface } from "../../src/prompt_values.cjs";
import { AsyncCaller, AsyncCallerParams } from "../../src/utils/async_caller.cjs";
import { JsonSchema7Type } from "../../src/utils/zod-to-json-schema/parseTypes.cjs";
import { ModelProfile } from "../../src/language_models/profile.cjs";
...
type LanguageModelLike = RunnableInterface<BaseLanguageModelInput, LanguageModelOutput>;
/**
...
declare abstract class BaseLanguageModel<RunOutput = any, CallOptions extends BaseLanguageModelCallOptions = BaseLanguageModelCallOptions> extends BaseLangChain<BaseLanguageModelInput, RunOutput, CallOptions> implements BaseLanguageModelParams, BaseLanguageModelInterface<RunOutput, CallOptions> {
  ...
  withStructuredOutput?<RunOutput extends Record<string, any> = Record<string, any>>(schema: ZodV3Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<false>): Runnable<BaseLanguageModelInput, RunOutput>;
  withStructuredOutput?<RunOutput extends Record<string, any> = Record<string, any>>(schema: ZodV3Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<true>): Runnable<BaseLanguageModelInput, {
    raw: BaseMessage;
    parsed: RunOutput;
  }>;
  withStructuredOutput?<RunOutput extends Record<string, any> = Record<string, any>>(schema: ZodV4Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<false>): Runnable<BaseLanguageModelInput, RunOutput>;
  withStructuredOutput?<RunOutput extends Record<string, any> = Record<string, any>>(schema: ZodV4Like<RunOutput> | Record<string, any>, config?: StructuredOutputMethodOptions<true>): Runnable<BaseLanguageModelInput, {
    raw: BaseMessage;
    parsed: RunOutput;
  }>;
  /**
   ...
   */
  protected _filterInvocationParamsForTracing(params: Record<string, any>): Record<string, any>;
}
/**
